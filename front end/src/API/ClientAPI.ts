...
export const AddClients = async (client: Client) => {
  try {
    const response = await axiosInstance.post("/api/Client", client);
...
export const UpdateClients = async (client: Client) => {
  try {
    const response = await axiosInstance.put(`/api/Client/`, client);
...
export const WithdrewAmounts = async (
...
export const fetchClientCount = async () => {
  try {
    const response = await axiosInstance.get("/api/Client/GetAllClientCount");
    return response.data;
  } catch (error) {
...
export const fetchTotallAccountBalances = async () => {
  try {
    const response = await axiosInstance.get(
      "/api/Client/GetTotallAccountBalance",
    );
    return response.data;
  } catch (error) {
...
export const findClients = async (accountNumber: string) => {
  try {
    const response = await axiosInstance.get(
      `/api/Client/account/${accountNumber}`,
    );
